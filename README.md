...
<h1 align="center">
  Oussama Souayeh: Cloudify Blog
</h1>

<p align="center">
  <a href="https://github.com/CloudOuss/oussama.souayeh.pro/blob/main/LICENSE">
    <img src="https://img.shields.io/badge/license-0BSD-blue.svg" alt="Cloudify Blog is released under the 0BSD license." />
  </a>
  <a href="https://oussama.souayeh.pro">
    <img alt="Website" src="https://img.shields.io/badge/-website-blue">
  </a>
  <a href="https://twitter.com/intent/follow?screen_name=CloudOuss">
    <img src="https://img.shields.io/twitter/follow/CloudOuss.svg?label=Follow%20@CloudOuss" alt="Follow @CloudOuss" />
  </a>
</p>

Technolog blog build with [React](https://reactjs.org/) & [Gatsby](https://www.gatsbyjs.com/). Includes tags/categories support and extensive features for code blocks such as live preview, line numbers, and line highlighting. Using the Gatsby Theme [`@lekoarts/gatsby-theme-minimal-blog`](https://github.com/LekoArts/gatsby-themes/tree/master/themes/gatsby-theme-minimal-blog).
...
To edit the hero text, update `src/@lekoarts/gatsby-theme-minimal-blog/texts/hero.mdx` file.

#### Changing the "Featured projects" part

To edit the "Featured projects" part, update `src/@lekoarts/gatsby-theme-minimal-blog/texts/bottom.mdx` to edit its content.
